...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "suluu/duration-pill": `${packageSrc}/duration-pill/index.ts`,
      ...
      "suluu/spotlight-card": `${packageSrc}/spotlight-card/index.ts`,
      "suluu/switch-toggle": `${packageSrc}/switch-toggle/index.ts`,
      "suluu/theme-toggle": `${packageSrc}/theme-toggle/index.ts`,
